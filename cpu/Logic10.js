...
// --- interface -------------------------------------------
function Logic10(name) { // @arg String: player name
    this._name = name;
    this._human = false;
}
Logic10.prototype.__proto__ = Player.prototype;
Logic10.prototype.logic = logic; // [override] #logic(color:CellValue, cell:CellValueArray, callback):Boolean
...
// --- export ----------------------------------------------
if (_NODE_JS) {
    module.exports = Logic10;
}
global.Logic10 = Logic10;
