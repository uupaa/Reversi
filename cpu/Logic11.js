...
// --- interface -------------------------------------------
function Logic11(name) { // @arg String: player name
    this._name = name;
    this._human = false;
}
Logic11.prototype.__proto__ = Player.prototype;
Logic11.prototype.logic = logic; // [override] #logic(color:CellValue, cell:CellValueArray, callback):Boolean
...
// --- export ----------------------------------------------
if (_NODE_JS) {
    module.exports = Logic11;
}
global.Logic11 = Logic11;
