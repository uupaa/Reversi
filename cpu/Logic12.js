...
// --- interface -------------------------------------------
function Logic12(name) { // @arg String: player name
    this._name = name;
    this._human = false;
}
Logic12.prototype.__proto__ = Player.prototype;
Logic12.prototype.logic = logic; // [override] #logic(color:CellValue, cell:CellValueArray, callback):Boolean
...
// --- export ----------------------------------------------
if (_NODE_JS) {
    module.exports = Logic12;
}
global.Logic12 = Logic12;
