...
// --- interface -------------------------------------------
function Logic16(name) { // @arg String: player name
    this._name = name;
    this._human = false;
}
Logic16.prototype.__proto__ = Player.prototype;
Logic16.prototype.logic = logic; // [override] #logic(color:CellValue, cell:CellValueArray, callback):Boolean
...
// --- export ----------------------------------------------
if (_NODE_JS) {
    module.exports = Logic16;
}
global.Logic16 = Logic16;
