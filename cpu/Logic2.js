...
// --- interface -------------------------------------------
function Logic2(name) { // @arg String: player name
    this._name = name;
    this._human = false;
}
Logic2.prototype.__proto__ = Player.prototype;
Logic2.prototype.logic = logic; // [override] #logic(color:CellValue, cell:CellValueArray, callback):Boolean
