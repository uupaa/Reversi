...
// --- interface -------------------------------------------
function Logic4(name) { // @arg String: player name
    this._name = name;
    this._human = false;
}
Logic4.prototype.__proto__ = Player.prototype;
Logic4.prototype.logic = logic; // [override] #logic(color:CellValue, cell:CellValueArray, callback):Boolean
...
// --- export ----------------------------------------------
if (_NODE_JS) {
    module.exports = Logic4;
}
global.Logic4 = Logic4;
