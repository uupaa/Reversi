...
// --- interface -------------------------------------------
function Logic5(name) { // @arg String: player name
    this._name = name;
    this._human = false;
}
Logic5.prototype.__proto__ = Player.prototype;
Logic5.prototype.logic = logic; // [override] #logic(color:CellValue, cell:CellValueArray, callback):Boolean
...
// --- export ----------------------------------------------
if (_NODE_JS) {
    module.exports = Logic5;
}
global.Logic5 = Logic5;
