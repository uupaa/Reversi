...
// --- interface -------------------------------------------
function Logic6(name) { // @arg String: player name
    this._name = name;
    this._human = false;
}
Logic6.prototype.__proto__ = Player.prototype;
Logic6.prototype.logic = logic; // [override] #logic(color:CellValue, cell:CellValueArray, callback):Boolean
...
// --- export ----------------------------------------------
if (_NODE_JS) {
    module.exports = Logic6;
}
global.Logic6 = Logic6;
