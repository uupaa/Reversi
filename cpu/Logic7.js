...
// --- interface -------------------------------------------
function Logic7(name) { // @arg String: player name
    this._name = name;
    this._human = false;
}
Logic7.prototype.__proto__ = Player.prototype;
Logic7.prototype.logic = logic; // [override] #logic(color:CellValue, cell:CellValueArray, callback):Boolean
...
// --- export ----------------------------------------------
if (_NODE_JS) {
    module.exports = Logic7;
}
global.Logic7 = Logic7;
